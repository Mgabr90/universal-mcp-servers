...
# Set environment variable before creating FastMCP instance
os.environ.setdefault('LOG_LEVEL', 'INFO')

# Create FastMCP with explicit settings
mcp = FastMCP(
    "pymupdf4llm-mcp",
    log_level='INFO'
)
...
def convert_pdf_to_markdown(
    ...
    try:
        # Process PDF once and reuse content - fixes duplicate processing bug
